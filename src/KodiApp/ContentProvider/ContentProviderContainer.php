...
class ContentProviderContainer implements \ArrayAccess
{
    /**
     * @var ContentProvider[]
     */
    ...
    /**
     * ContentProviderContainer constructor.
    ...
    {
        if($this->providers[$offset] instanceof  ContentProvider) {
            return $this->providers[$offset]->getValue();
        }
